...
export const getAllCountries = async () => {
  ...
  return await fetch('https://pi-countries-back-production-d848.up.railway.app/countries')
              .then(res => {
...
export const getCountriesByName = async (name) => {
  ...
  return await fetch('https://pi-countries-back-production-d848.up.railway.app/countries?name=' + name)
  .then(res => {
    if (!res.ok) throw new Error('Countries not found');
    return res.json()
  })
...
export const getCountriesById = async (id) => {
  ...
  return await fetch('https://pi-countries-back-production-d848.up.railway.app/countries/' + id)
  .then(res => {
...
export const getAllActivities = async () => {
  ...
  return await fetch('https://pi-countries-back-production-d848.up.railway.app/activities')
              .then(res => {
...
export const postActivity = async (activity) => {
  try {
    ...
    const sendActivity = await axios.post('https://pi-countries-back-production-d848.up.railway.app/activities', activity);
